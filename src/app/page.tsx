  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Loved by developers worldwide</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                "This platform completely transformed my understanding of algorithms. The interactive exercises and
                clear explanations made complex topics accessible."
              </p>
              <div className="flex items-center">
                <div className="w-12 h-12 bg-gradient-to-br from-emerald-400 to-teal-400 rounded-full flex items-center justify-center text-white font-bold mr-4">
                  S
                </div>
                <div>
                  <div className="font-semibold text-gray-900">Sarah Chen</div>
                  <div className="text-gray-500 text-sm">Software Engineer at Google</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                "I landed my dream job at Meta after completing this course. The structured approach and practice
                problems were exactly what I needed."
              </p>
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <div className="text-gray-500 text-sm">Full Stack Developer at Meta</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                "The progress tracking feature helped me identify my weak areas and focus my study time effectively.
                Highly recommended!"
              </p>
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <div className="text-gray-500 text-sm">CS Student at Stanford</div>
                </div>
              </div>
            </div>
          </div>
